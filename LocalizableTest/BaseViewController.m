...
@interface BaseViewController () <UIActionSheetDelegate,WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler>
...
- (void)configUI {
    ...
    [self.webView.configuration.userContentController addScriptMessageHandler:self name:@"webViewApp"];
...
- (void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message {
    ...
    NSString *param = [dic valueForKey:@"param"];
...
- (void)hello:(NSString *)name {
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"app" message:[NSString stringWithFormat:@"hello:%@", name] preferredStyle:UIAlertControllerStyleAlert];
